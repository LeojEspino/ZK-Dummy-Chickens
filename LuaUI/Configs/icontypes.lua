...
-- commanders
  ...
  c_warrior = {
    bitmap='icons/c_warrior.dds',
    size=1.25,
  },
  c_gunner = {
    bitmap='icons/c_gunner.dds',
    size=1.25,
  },
  c_thief = {
    bitmap='icons/c_thief.dds',
    size=1.25,
  },
  c_mage = {
    bitmap='icons/c_mage.dds',
    size=1.25,
  },
  c_defender = {
    bitmap='icons/c_defender.dds',
    size=1.25,
  },
  c_destroyer = {
    bitmap='icons/c_destroyer.dds',
    size=1.5,
  },
  c_mercenary = {
    bitmap='icons/c_mercenary.dds',
    size=1.5,
  },
  c_stalker = {
    bitmap='icons/c_stalker.dds',
    size=1.5,
  },
  c_grenadier = {
    bitmap='icons/c_grenadier.dds',
    size=1.5,
  },
  c_juggernaut = {
  ...
  c_trickster = {
    bitmap='icons/c_trickster.dds',
    size=1.75,
  },
  c_bomber = {
    bitmap='icons/c_bomber.dds',
    size=1.75,
  },
  c_admiral = {
    bitmap='icons/c_admiral.dds',
    size=1.75,
  },
  chickena = {
